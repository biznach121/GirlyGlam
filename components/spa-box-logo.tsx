...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783461581/stage4/spa_girlyglamgallery/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Girly Glam Gallery - Where girls get their glam">
        <Image
          src={src}
          alt="Girly Glam Gallery - Where girls get their glam"
          fill
