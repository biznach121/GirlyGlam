...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#8e001a] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#9f0027]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(94, 0, 14,0.58),rgba(128, 0, 25,0.22)_43%,rgba(96, 0, 18,0.34)),linear-gradient(0deg,rgba(50, 2, 9,0.18),rgba(50, 2, 9,0.08))]" />
