...
export const brand: Brand = {
  name: "Girly Glam Gallery",
  shortName: "Girly Glam",
  microTag: "WHERE GIRLS GET THEIR GLAM",
  description:
    "Girly Glam Gallery in Accra shapes lashes and brows that look like yours, only better — precise, comfortable and made to hold.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0557734129",
    phoneTel: "+233557734129",
    textPhone: "0270030384",
    textPhoneTel: "+233270030384",
    email: "hello@girlyglam.test",
    privacyEmail: "privacy@girlyglam.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@girlyglamgallery", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "lashes, skin and\nmain-character energy.\nWhere girls get their glam.",
    subtitle:
      "Lash extensions, brows and beauty in Accra — book your appointment today",
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "That is the gap Girly Glam Gallery was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Girly Glam Gallery beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Girly Glam Gallery self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Girly Glam Gallery beauty ritual",
      ...
      },
      {
        ...
        alt: "Girly Glam Gallery calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Girly Glam Gallery relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Girly Glam Gallery beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Girly Glam Gallery lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Girly Glam Gallery mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Girly Glam Gallery makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Girly Glam Gallery foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@girlyglamgallery",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783461589/stage4/spa_girlyglamgallery/tiktok_0.mp4",
        alt: "Girly Glam Gallery treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783461600/stage4/spa_girlyglamgallery/tiktok_1.mp4",
        alt: "Girly Glam Gallery treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783461607/stage4/spa_girlyglamgallery/tiktok_2.mp4",
        alt: "Girly Glam Gallery treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Girly Glam Gallery self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Girly Glam Gallery studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Girly Glam Gallery",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Girly Glam Gallery is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0557734129 and text 0270030384 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0557734129, text 0270030384, or message @girlyglamgallery on Instagram." },
          ...
          { q: "Where are you located?", a: "Girly Glam Gallery is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@girlyglam.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Girly Glam Gallery (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@girlyglam.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Girly Glam Gallery is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@girlyglam.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Girly Glam Gallery",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0557734129", href: "tel:+233557734129" },
      { label: "Text", value: "0270030384", href: "sms:+233270030384" },
      { label: "Instagram", value: "@girlyglamgallery", href: "https://www.tiktok.com/@girlyglamgallery" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783461582/stage4/spa_girlyglamgallery/avatar.jpg",
    blurb:
      "Girly Glam Gallery in Accra — where girls get their glam.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@girlyglamgallery" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0557734129", href: "tel:+233557734129" },
          { label: "Text 0270030384", href: "sms:+233270030384" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Girly Glam Gallery — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
